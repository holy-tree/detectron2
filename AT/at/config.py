...
def add_at_config(cfg):
    ...
    # _C.INPUT.MIN_SIZE_TRAIN = (262, 444)
    # _C.INPUT.MAX_SIZE_TRAIN = 867
    ...
    _C.MODEL.VGG = "./weights/vgg16_ori.pth"
    ...
    _C.SEMISUPNET.DIS_LOSS_WEIGHT = 0.0
    _C.SEMISUPNET.CONT_CONS_LOSS_WEIGHT = 0.1
    _C.SEMISUPNET.INS_CONS_LOSS_WEIGHT = 0.1
